"""Detect and redact secret-shaped strings before telemetry leave the device.

Research goal: measure how often secrets appear in prompts/code without
retaining recoverable API keys.
"""
